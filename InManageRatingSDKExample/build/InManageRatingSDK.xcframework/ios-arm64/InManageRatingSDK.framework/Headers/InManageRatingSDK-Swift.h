...
#ifndef INMANAGERATINGSDK_SWIFT_H
#define INMANAGERATINGSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InManageRatingSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)
@protocol InmanageDelegate;
@class NSString;
@class UIColor;
@class RateUsFields;
@class ThanksForRatingFields;
@class RateInAppstoreFields;
@class RateWithCommentFields;
@class UIView;

SWIFT_CLASS("_TtC17InManageRatingSDK14InManageRating")
@interface InManageRating : NSObject
@property (nonatomic, weak) id <InmanageDelegate> _Nullable delegate;
@property (nonatomic) BOOL isDebugMode;
/// Initialize <code>InManageRating</code> (as singleton)
...
- (nonnull instancetype)initWithImgBackgroundHeader:(UIImage * _Nonnull)imgBackgroundHeader imgMainCenterHeader:(UIImage * _Nonnull)imgMainCenterHeader translatingMainTitleLowRating:(NSString * _Nullable)translatingMainTitleLowRating translatingMainTitleHighRating:(NSString * _Nullable)translatingMainTitleHighRating translatingMainContent:(NSString * _Nullable)translatingMainContent translatingBtnClose:(NSString * _Nullable)translatingBtnClose OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
